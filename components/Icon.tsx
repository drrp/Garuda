...
interface IconProps {
  ...
  name: 'copy' | 'check' | 'loading' | 'sparkles' | 'download' | 'code' | 'trash' | 'history' | 'close' | 'dev' | 'chevron-down' | 'book-open' | 'document-text' | 'search' | 'edit' | 'arrow-right' | 'menu' | 'home' | 'google' | 'stop' | 'reset';
  className?: string;
}
